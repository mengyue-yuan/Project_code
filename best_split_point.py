...
def get_best_split_point(feature_list,label):
    ...
    for index in range(0,len(middle_point_list)):
        ...
        # 统计小于等于分割值,类别属于Iris-versicolor点的数量

        nY1 = dic_Y['"Iris-versicolor"']
        # 统计小于等于分割值,类别属于Iris-setosa点的数量
        nY2 = dic_Y['"Iris-setosa"']
        # 统计小于等于分割值,类别属于Iris-virginica点的数量
        nY3 = dic_Y['"Iris-virginica"']
        # 统计大于分割值,类别属于Iris-versicolor点的数量
        nN1 = dic_N['"Iris-versicolor"']
        # 统计大于分割值,类别属于Iris-setosa点的数量
        nN2 = dic_N['"Iris-setosa"']
        # 统计大于分割值,类别属于Iris-virginica点的数量
        nN3 = dic_N['"Iris-virginica"']
...
#
# best_spilt_point,max_gain = get_best_split_point(feature_list,label)
# print(best_spilt_point,max_gain)